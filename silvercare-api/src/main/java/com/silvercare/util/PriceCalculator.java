 ...
 * Centralizes all seasonal pricing logic for consistency across the application.
 */
public class PriceCalculator {
     ...
     * @return Calculated price rounded to 2 decimal places, or basePrice if inputs are null
     */
     ...
     * Modifies the services in place by setting their seasonalPrice and currentSeason fields.
     * 
