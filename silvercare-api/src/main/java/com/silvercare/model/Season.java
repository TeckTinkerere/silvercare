...
public enum Season {
     ...
     * 
     * @param columnName The database column prefix for this season (e.g., "spring")
     * @param displayName The human-readable display name for this season (e.g., "Spring")
     */
     ...
     * 
     * @return The multiplier column name (e.g., "spring_multiplier", "summer_multiplier")
     */
