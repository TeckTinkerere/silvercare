<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>Add Service - SilverCare Admin</title>
        ...
        <body>
            ...
            <div class="content">
                ...
                <div class="page-header mb-4">
                    <h1><i class="bi bi-plus-circle text-primary me-2"></i>Add New Service</h1>
                    <p class="text-muted">Create a new service offering for your customers.</p>
                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="service_name" name="service_name"
                                        placeholder="e.g. In-Home Nursing" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="image_url" name="image_url"
                                            placeholder="e.g., images/p101.png">
                                    </div>
                                    <small class="text-muted">Path relative to webapp root</small>
                                </div>
                            </div>
